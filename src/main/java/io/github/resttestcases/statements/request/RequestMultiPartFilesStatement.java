...
public class RequestMultiPartFilesStatement extends LeafNodeStatement {
    ...
    public void execute(Context context) {
        ...
        for (Entry<String, String> it : this.params.entrySet()) {
            try {
                ...
                req.multiPart(it.getKey(), it.getValue(), IOUtils.toByteArray(in));
            } catch (IOException e) {
                throw new AssertionError("Error reading resource: " + it.getValue() + "." + e.getMessage());
            }
        }
    }
}
