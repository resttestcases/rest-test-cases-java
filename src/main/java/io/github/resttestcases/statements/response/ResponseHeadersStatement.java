...
public class ResponseHeadersStatement extends LeafNodeStatement {
	...
	public void execute(Context context) {
		...
		ValidatableResponse validate = context.getParam(ValidatableResponse.class.getName());
		for (Entry<String, String> it : params.entrySet()) {
			logger.debug("Valid response header {}", it.getKey());
